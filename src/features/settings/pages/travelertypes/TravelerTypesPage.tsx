...
export default function TravelerTypesPage() {
  ...
  const label = t('travelerTypes') || 'TravelerTypes'
  const { data: items = [], isLoading } = useSettingsList('travelertypes', search)

  const createMutation = useCreateSettingsItem('travelertypes')
  const updateMutation = useUpdateSettingsItem('travelertypes')
  const deleteMutation = useDeleteSettingsItem('travelertypes')
