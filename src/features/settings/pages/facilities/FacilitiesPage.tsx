...
export default function FacilitiesPage() {
  ...
  const { data: items = [], isLoading } = useSettingsList('facilities', search)

  const createMutation = useCreateSettingsItem('facilities')
  const updateMutation = useUpdateSettingsItem('facilities')
  const deleteMutation = useDeleteSettingsItem('facilities')
