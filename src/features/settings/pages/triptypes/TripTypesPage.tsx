...
import {
  ...
  useUpdateTripType,
  useDeleteTripType,
  useToggleTripTypeStatus
} from '../../api/useTripTypes'
import { getTripTypesColumnDefs } from './ColumnDefs'
import { TripTypesFormModal } from './TripTypesFormModal'
...
export default function TripTypesPage() {
  ...
  const label = t('tripTypes') || 'Trip Types'
  ...
  const columnDefs = getTripTypesColumnDefs({
    t,
    toggleMutation,
    setEditingItem,
    setIsModalOpen,
