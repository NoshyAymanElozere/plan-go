...
export default function TermsConditionsPage() {
  ...
  const { data: itemData, isLoading } = useSettingsSingle('termsconditions')
  const saveMutation = useSaveSettingsSingle('termsconditions')
  ...
  return (
    <Card className="border-border/60 shadow-sm rounded-2xl overflow-hidden bg-white">
      <CardHeader className="border-b border-gray-50 px-6 py-5">
        <CardTitle className="text-lg font-bold text-gray-800">{t('termsConditions') || 'TermsConditions'}</CardTitle>
      </CardHeader>
