...
export default function AboutUsPage() {
  ...
  const { data: itemData, isLoading } = useSettingsSingle('aboutus')
  const saveMutation = useSaveSettingsSingle('aboutus')
  ...
  return (
    <Card className="border-border/60 shadow-sm rounded-2xl overflow-hidden bg-white">
      <CardHeader className="border-b border-gray-50 px-6 py-5">
        <CardTitle className="text-lg font-bold text-gray-800">{t('aboutUs') || 'AboutUs'}</CardTitle>
      </CardHeader>
