...
export default function RatingsPage() {
  ...
  const { data: items = [], isLoading } = useSettingsList('ratings', search)

  const createMutation = useCreateSettingsItem('ratings')
  const updateMutation = useUpdateSettingsItem('ratings')
  const deleteMutation = useDeleteSettingsItem('ratings')
