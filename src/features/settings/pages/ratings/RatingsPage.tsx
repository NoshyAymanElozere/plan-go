...
import {
  useHotelRatingsList,
  useCreateHotelRating,
  useUpdateHotelRating,
  useDeleteHotelRating,
  useToggleHotelRatingStatus
} from '../../api/useHotelRatings'
import { getRatingsColumnDefs } from './ColumnDefs'
...
export default function RatingsPage() {
  ...
  const { data: paginatedData, isLoading } = useHotelRatingsList(page, search)
  const items = paginatedData?.data || []

  const createMutation = useCreateHotelRating()
  const updateMutation = useUpdateHotelRating()
  const deleteMutation = useDeleteHotelRating()
  const toggleMutation = useToggleHotelRatingStatus()
  ...
  const columnDefs = getRatingsColumnDefs({
    t,
    toggleMutation,
    setEditingItem,
    setIsModalOpen,
